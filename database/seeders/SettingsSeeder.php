...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ['group_name' => 'ar', 'key_name' => 'website_title', 'value' => 'جريدة', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['group_name' => 'ar', 'key_name' => 'status', 'value' => '1', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['group_name' => 'en', 'key_name' => 'website_title', 'value' => 'Jareeda', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
